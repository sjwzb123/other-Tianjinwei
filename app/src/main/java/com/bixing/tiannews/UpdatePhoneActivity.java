...
public class UpdatePhoneActivity extends BaseActivity {
    ...
    private void reg() {
        ...
        // return;
        // }
        HttpManager.updatePhone(SpfManger.getToken(this), phone, code, new HttpCallBack() {
            @Override
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (responsBean.isSucc()) {
                            finish();
                            ToastUtils.toast(UpdatePhoneActivity.this, responsBean.getMsg());
    ...
    private void getCode() {
        ...
        HttpManager.getSmsCode(phone, "3", new HttpCallBack() {
            @Override
            public void onFailure(String errCode, String errMsg) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (responseBean.isSucc()) {
                            ToastUtils.toast(UpdatePhoneActivity.this, "验证码发送成功请注意查收！");
                        } else {
                            ToastUtils.toast(UpdatePhoneActivity.this, responseBean.getMsg());
                        }
                    }
                });
            }
